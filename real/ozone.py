...
# User specify the root path.
root_path = '/Users/yjzeng/Desktop/FANOVA/'

# The results are will be stored in the path "root.path/real/ozone/results",
# thus please make sure the dictionary has been created.


df = pd.read_csv(root_path+'real/ozone/ozone.data', sep=',',header=0)
splits = pickle.load(open(root_path+"real/ozone/ozone_splits.pkl", "rb"))
...
if __name__ == "__main__":
    for method in ['GPANOVA', 'SSANOVA']:
        f = open(root_path + f'real/ozone/ozone_{method}_results.txt', 'w')
        f.write("========================================================\n")
        f.write(
        ...
        for omega in omega_list:
            ...
            pickle.dump(results, open(root_path+f"real/ozone/results/ozone_{method}_w_{omega}_10cv_results.pkl", 'wb'))
